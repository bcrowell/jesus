...
between absolute and emphatic was disappearing for nouns, so there were two states. The construct state is used for
...
Either one is a grammatically possible construal of the same
Aramaic utterance ``barnasha.'' When the evangelists wrote down their translations of Jesus's Aramaic words into Greek,
which does have a distinction between the two, they therefore had a choice, and they generally translated it 
using the definite article ``ο,'' as in Mark 2:10, ``ο υιος του ανθρώπου.''
...
For example, God uses it over and over in Ezekiel as a form of address to Ezekiel, something like ``O mortal man.''
...
title for himself. Let's focus on Mark.
...
and (3) ignore all Jesus's usages of the phrase that are ruled out by naturalistic and historical criteria.
...
right to violate the rules and prerogatives ordained by God and enforced by the theocracy. ``You can't do that,''
In both cases, there is then a very natural way of understanding Jesus's comeback: ``Anyone can do that.''
That is, ``anyone has authority to forgive sins,'' and ``man is lord even of the sabbath.''

These readings make much more sense than the ones given in most
translations, which make a mysterious distinction without a
difference, like ``the Man With Two Legs,'' but say that this
distinction grants ``authority on earth'' or makes someone ``lord.''
...
meaning. But perhaps it was made clear to his followers, privately,
that this was really a reference to Daniel 7:13. We don't have to speculate about whether Jesus was in danger and knew it.
...
It's even possible that this possible double entendre was understood on both sides of Jesus's
...
air at the time, especially if the non-canonical Book of Enoch was known to them.
