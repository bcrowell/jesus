...
\luke{4:28}{ They were all filled with wrath in the synagogue as they heard these things.   They rose up, threw him out of the city, and led him to the brow of the hill that their city was built on, that they might throw him off the 
...
\notewithoutbackref{son-of-man}, not as a title, so that the
original verse would have been ``The sabbath was made for man, not man for the sabbath. Therefore man is lord even of the sabbath.}] is lord even of the sabbath.'' 
}
...
``A son of man'' is a Hebrew and Aramaic phrase meaning a human being. In these languages, it's the same as ``a son of Adam,'' since
the name Adam just means ``man.'' 
Jesus sometimes uses it in this normal sense (\reftex{Mark 2:27-28}, p.~\pageref{foraging-on-sabbath}),
but often also seems to use it as a title when referring to 
himself. The grammatical distinction is clear in Greek but not  in the Aramaic language that Jesus spoke.
The Greek ``ο υιος του ανθρώπου'' in Mark 2:10 has the definite article ``ο.'' 
...
The phrase has two possible layers of meaning.
Jesus was considered by his community to be a mamzer, a person born of forbidden sex.
In a scene like \reftex{Mark 2:1}, p.~\pageref{paralytic}, Jesus is challenged by scribes in a rabbinic
debate about his authority to forgive the sins of a paralytic after healing him.
If Jesus actually spoke these words, it was in Aramaic, so the distinction between a generic ``a son of Adam'' and the
evangelists' Greek self-title ``the Son of Man'' would not have been audible.
The scribes can, if they wish, hear Jesus's words in Aramaic simply as Jesus claiming that ``anyone has the authority.''
Compare with Psalms 8:4: ``What is the son of man, that you care for him? 
For you have made him a little lower than the angels,
and crowned him with glory and honor.
  You make him ruler over the works of your hands.''
But because the idiom for ``male human being'' is ``son of a man,'' there is an additional implied
emphasis on throwing back his mamzer status in their faces.

As a second layer of meaning, the idiosyncratic phrase seems to
preserve a historical fact that Jesus secretly told his followers that he was the messiah, while using coded
...
or ahistorical (the historically impossible trial before the sanhedrin, 14:62). The remaining two can both be read as
generic usages of ``son of man.''

Some experts are skeptical about whether Jesus ever used ``son of man'' as a title to refer to himself\footnote{Funk, pp. 76-77, 
but see Beilby, p.~221} or suggest that the messianic meaning was never
understood, even as an implication for an in-group, during Jesus's lifetime. This is impossible.
Jesus's use of the phrase as a self-title is a verbal habit as characteristic as anything can be of the oral memory of Jesus's words.
And when Jesus uses the phrase in 2:10 and 2:28, he's engaging in learned rabbinical debate, pitting his working man's
total recall of the oral targum against his opponents' book learning. It's not possible that the scribes and pharisees are
ignorant of the fact that the phrase has two different meanings. In both versus and with both interpretations, it wins the
argument for Jesus. And in both cases, its ambiguity gives him plausible deniability.
