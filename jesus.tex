...
\newcommand{\bible}[2]{\begin{quotetext}\textbf{#1}\index[texts]{#1} #2\end{quotetext}}
...
\comm{In John 2:1-11, Jesus turns water in to wine at the wedding at Cana.}
...
\comm{Tacitus (quoted at greater length on p.~\pageref{tacitus}) confirms Jesus's execution at the hands of Pontius Pilate:}\index[texts]{Tacitus}

\begin{quotetext}
Christus, from whom the name had its origin, suffered
the extreme penalty during the reign of Tiberius at the hands of one
of our procurators, Pontius Pilatus \ldots
\end{quotetext}
...
\comm{There was a great fire in 64 CE during the reign of Nero. The Roman historian wrote the following around 116 CE (translated
...
The miracles are there, as are the appearances of the resurrected Jesus.
...
\hfill\pagebreak\section*{List of works consulted}
...
\hfill\pagebreak\printindex

\hfill\pagebreak\printindex[texts]
