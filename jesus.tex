...
by Herod Antipas means that he was within his jurisdiction, which covered Galileee and Perea. To attract large
...
\comm{Jesus fails in Nazareth and is nearly executed.}
...
in his hometown.''\footnote{Jesus explains his lack of healing power in his hometown to be a punishment for
...
cliff.\footnote{They try to execute him, apparently for the crime of false prophecy \note{false-prophecy-executation}. The
violent incident is absent from Mark.}   But he, passing through the middle of them, went his way.}

\comm{\reftex{John 7-8} is probably Christian fiction, but it includes plausible material to the effect that Jesus was in danger
of arrest, sneaking around, and alienated from his family:}

\john{7:1}{
\ldots Jesus was walking in Galilee, for he wouldn't walk in Judea, because the Jews sought to kill him.   Now the feast of the Jews, Sukkot, was at hand.   His brothers therefore said to him, ``Depart from here and go into Judea, that your disciples also may see your works which you do.   For no one does anything in secret while he seeks to be known openly. If you do these things, reveal yourself to the world.''   For even his brothers didn't believe in him.
}

\comm{It's difficult to know whether passages like Luke 4:28 and John 7:1 are real or attempts to dramatize the conflict.
John is often anti-semitic, and uses words like ``the Jews'' in ways that are over-generalized and don't make sense, since Jesus, his
family, and his followers were all Jews. John wants to deflect blame for Jesus's death away from the Romans, since by John's time
Christianity was flourishing among the gentiles.}
...
\item Christian symbolism used before it existed.
...
\item ``I will destroy this temple that is made with hands, and in three days I will build another made without 
    hands.''\footnote{\reftex{Mark 14:58}, with similar examples in \reftex{Mark 8:31}, \reftex{Mark 13:2}, \reftex{Mark 15:29}, \reftex{Luke 19:43},
...
\item Prophecy of betrayal and derision:
    ``How is it written about the Son of Man, that he should suffer many things and be despised?''\footnote{\reftex{Mark 9:12}}
    ...
    Jesus would be crucified.\footnote{And the scriptural references don't even make much sense as prophecies. For example, \reftex{Psalms 22:1},
...
\item Novel statements and commands by the resurrected Jesus (e.g., \reftex{Matthew 28:19}).
    ...
    his followers' minds.
\item Any discourse containing material that is clearly fabricated on the basis of other criteria (e.g., Matthew 16:24-28).
\end{enumerate}
...
Tax collectors were shunned by the Jews, and reaching out to include them was a remarkable feature of Jesus's mission, not John's.
...
\reftex{John 7:8} gives an example where Jesus skips one such pilgrimage for fear of arrest.
