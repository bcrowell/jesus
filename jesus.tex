...
of his description of these apostates, Pliny provides the earliest historical description of early Christian
forms of worship:}
...
in Jerusalem, and in Mark 11, for example, all the coming and going to the temple with impunity may seem hard to believe, especially
if the authorities were now so intent on killing Jesus. Actually 
Jesus would have been obligated to make pilgrimmages to
Jerusalem every year for three different festivals, one of which was Passover, so in fact the
