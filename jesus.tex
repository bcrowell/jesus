...
although Paul dictates them without citing any orally transmitted sayings by Jesus;\footnote{Price, in Beilby, p.~67}
Paul instead justifies them, when necessary, by citing the Hebrew scriptures (which very few
...
C.D.~Stanley, \emph{Paul and the language of scripture}, p.~33.}\label{paul-tinkering}).
}
...
\notetext{peter}{Biographical sketch of Peter}\label{Peter!biographical sketch}
...
is not above falsifying quotations from the Hebrew scriptures in order to support his authority (p.~\pageref{paul-tinkering}).
