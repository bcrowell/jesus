...
\comm{
Josephus was enslaved by the Romans and then freed, worked for them as a translator, and became a Roman citizen.
We can see that Josephus is a knowledgeable informant about this type of dissident movement, and also that it
...
Jesus's baptism is also attended by a supernatural appearance by God, which doesn't meet my criteria for inclusion \ref{in-you-i-am-well-pleased}.}
...
is a retrodiction of later Christian teachings to a time when those teachings didn't exist. The earliest manuscript, frequently
