...
\comm{Luke and John portray Jesus living on the run from the law, constantly in danger
of arrest, sneaking around, and alienated from his family. It's difficult to know whether or not this is historical. Mark doesn't
describe these events. Passages like these may be attempts to dramatize the conflict, and in John's case there is an
overt anti-semitic agenda of deflecting blame for the crucifixion from the Romans to ``the Jews.'' \reftex{John 7-8} is probably Christian fiction,
and \reftex{John 7:1-8} doesn't meet my criteria for inclusion because of its ahistorical description of ``the Jews.'' \notewithoutbackref{about-this-doc}}
...
\luke{13:31}{
\ldots some Pharisees came, saying to him, ``Get out of here and go away, for Herod wants to kill you.''
}
...
There were separate Roman and Herodian militaries,\footnote{Chilton, p.~64} but even if the soldiers were Jews serving Herod,
...
the fact that they contradict the rest of Matthew also marks them as fabrications by some later editor.
