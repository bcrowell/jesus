...
\subhead{The kingdom of God}

\comm{Translations from the Gospel of Thomas are by T.P.~Brown (see p.~\pageref{brown-trans}).}
...
\subhead{The greatest commandments}
...
Translations of the Gospel of Thomas are  by T.P.~Brown, \url{freelyreceive.net}. I omit the ``Jesus saids''
and ``Whoever has ears, let him hears.''\label{brown-trans}
