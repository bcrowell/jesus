...
along with a ``massacre of the innocents'' (\reftex{Matthew 2:16}).} Embedded in the miraculous birth stories is the statement
...
Working from naturalistic assumptions, this means that Jesus was what we would today call an illegitimate child.
In his conceptual world, he was considered a \emph{mamzer},\footnote{Chilton,
\url{https://bibleinterp.arizona.edu/articles/2005/10/chi298001}} which doesn't have to do with marriage but means someone born from forbidden sex.
...
anomalous except that, as a mamzer, he was forbidden from marrying most Jewish women, the exceptions being other marginalized
...
\comm{John is executed by Herod Antipas, leaving his student Jesus lost and confused.}
...
For a reader of the gospels who hasn't been exposed to Christian doctrine, one of the first stumbling blocks is
the repeated use of the phrase ``son of man,'' which appears to be some kind of mysterious in-group cant, possibly invented
by the cult that grew up after Jesus's mission ended in unexpected and inexplicable disaster.
...
% sci-hub.do/10.1017/S0028688500026448

``Son of man'' is a poetic Hebrew and Aramaic idiom for a human being. In these languages, it's the same as ``a son of Adam,'' since
...
In Aramaic, either one is a grammatically possible construal of
...
using a definite article,\footnote{Koine Greek has definite articles but no indefinite articles.
...
such as ``ο'' in Mark 2:10, ``ο υιος του ανθρώπου.''

Going backwards, the most common assumption is that ``barnasha'' was the Aramaic phrase that Jesus spoke.
Another likely possibility would have been something like ``hahu barnasha,'' ``this-here son of man,''
...
``Bar gabra'' or the absolute ``bar enash'' are also possible.\footnote{Burkett, pp.~515-516}
...
It can emphasize man's weakness and inferiority to God, but it can also be used to talk about man's superiority
...
Christians prefer to point to one place in the
...
parts of Enoch were not among the fragments found at Qumran. The messianic interpretation of Daniel 7:13
seems only to have existed after Jesus's lifetime.

``Son of man'' occurs 95 times in Ezekiel, 20 times elsewhere in the Hebrew bible, 83 times
on the lips of Jesus, and once as spoken by Stephen in Acts 7:56. Jesus never uses any other messianic
title for himself. Notably, it never occurs in Paul.
...
This raises the possibility that Jesus simply never used the phrase, and it was only put in his mouth by Christians
as a way of ascribing to him messianic ambitions that he himself never expressed.\footnote{Funk, pp. 76-77, 
but see Beilby, p.~221}
But however prolific and inventive they were as authors of fiction, they were constrained by oral traditions about
what kinds of things Jesus said, and this phrase comes across as more of a personal signature phrase for Jesus,
like Star Trek's Captain Picard saying ``Make it so.'' Whenever we write our Star Trek fan fiction and Picard walks
on stage, we make sure to stick in some make-it-sos, because that's what the fans are expecting.

So let's (1) assume that Jesus did use ``son of man,'' (2) focus on Mark as the least fictionalized gospel,
and (3) ignore all usages that are ruled out by naturalistic and historical criteria.
This leaves only the two examples in Mark 2. Both of these occur in the context of rabbinical debates between
...
There is an additional obvious reason why Jesus would choose this particular phrase as his signature.
He was considered by his community to be a mamzer, a person born of forbidden sex, and they
...
More speculatively, we have yet another possible layer of meaning.
Supposing that the messianic interpretation of Daniel 7:13 already existed during Jesus's
lifetime (a hypothesis for which there is no hard evidence),
the idiosyncratic phrase may preserve a historical fact that Jesus
secretly told his followers that he was the messiah, while using coded
language to avoid getting in political trouble for it. It would have
had plausible deniability, especially because ``son of man'' is used
so many times in the Hebrew bible with so many differing shades of
meaning, almost none of them even arguably messianic. But perhaps it was made clear to his followers, privately,
that this was really a messianic code word. We don't have to speculate about whether Jesus was in danger and knew it.
Luke 4:28 depicts Jesus as narrowly escaping the stylized form of capital punishment prescribed for
false prophets, at  the hands of an angry mob in Nazareth.

It's even possible that such a double entendre was understood on both sides of Jesus's
debates. When Jesus uses the phrase in 2:10 and 2:28, he's engaging in learned rabbinical debate, pitting his working man's
total recall of the oral targum against his opponents' book learning. It's not possible that the scribes and pharisees are
ignorant of the fact that the phrase has a variety of meanings. On a reading of the Hebrew bible without the historical
context of first-century Palestine, the isolated example in  Daniel 7:13 would not necessarily spring to mind, nor would it be
clear that it had anything to do with a messiah. But the idea of Daniel 7:13 as a messianic prophecy may have been in the
air at the time.
...
these commands don't meet my criteria for inclusion (\notewithoutbackref{about-this-doc}), and
...
manufacture the words in 10:5 and 15:24, or did Mark and Luke erase them? The latter seems more likely,
